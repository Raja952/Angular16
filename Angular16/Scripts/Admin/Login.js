...
//    var url = $("#loginModal").attr("action");

//    var formdata = new FormData();

//    formdata.append("UserId", $("#txtUserName").val());
//    formdata.append("Password", $("#txtPasswordForgot").val());
//    //var formData = $(this).serialize(); // serialize form data
...
//    var url = $("#ForgetPasswordModal").attr("action");

//    var formdata = new FormData();

//    formdata.append("UserName", $("#Ftxtuserid").val());
//    formdata.append("EmailId", $("#Ftxtemailid").val());
//    //var formData = $(this).serialize(); // serialize form data
...
//    }).done(function (response) {
//        if (Response) {
//            alert("Chek Your Email Password sent to your email");
//        }
//        else {
//            alert("Invalid Form data!");
//        }
